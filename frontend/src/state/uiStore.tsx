 ...
 * the list of all UIs that can be installed and the live status of any UIs
 * that are currently managed by the application.
 */
interface UiState {
    // State properties
 ...
 * known to the application. It encapsulates the lists of available and installed UIs,
 * and provides a single action to refresh this data from the backend.
 *
 * Any component that needs to display or interact with UI environments can now
 * get this information directly from this store, eliminating the need for props
 * to be passed down from `App.tsx`.
 */
export const useUiStore = create<UiState>((set) => ({
     ...
     * all possible UIs that can be installed and the current statuses of any UIs
     * that have already been installed or adopted.
     */
    fetchUiData: async () => {
        set({ isLoading: true });
        try {
